...
// it means every machine fights over the same file.
//
// Dependency-free path math, so every app may import it without breaching the
// rule that only the store touches the ledger.
